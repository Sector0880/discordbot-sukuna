	...
	class Errors:
		class Terminal:
			def get_error_terminal_command_error(self):
				with open("./.db/doc/errors/terminal/terminalCommandError.yml", encoding="utf-8") as read_file: return yaml.safe_load(read_file)
			def get_error_terminal_traceback_error(self):
				with open("./.db/doc/errors/terminal/terminalTracebackError.yml", encoding="utf-8") as read_file: return yaml.safe_load(read_file)

		def get_error_command_not_found(self):
			with open("./.db/doc/errors/commandNotFound.yml", encoding="utf-8") as read_file: return yaml.safe_load(read_file)
		def get_error_server_blocked(self):
			with open("./.db/doc/errors/serverBlocked.yml", encoding="utf-8") as read_file: return yaml.safe_load(read_file)
...
# другое
files_status_txt = open("./.db/files_status.txt", encoding="utf-8")