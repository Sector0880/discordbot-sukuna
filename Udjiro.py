...
async def reload_cogs(ctx):
	...
	for filename in os.listdir("./botConfiguration/cogs/events/guilds"):
		if filename.endswith(".py"):
			await bot.reload_extension(f"botConfiguration.cogs.events.guilds.{filename[:-3]}")
	for filename in os.listdir("./botConfiguration/cogs/events/bot"):
		if filename.endswith(".py"):
			await bot.reload_extension(f"botConfiguration.cogs.events.bot.{filename[:-3]}")
	for filename in os.listdir("./botConfiguration/cogs/commands"):
		if filename.endswith(".py"):
			await bot.reload_extension(f"botConfiguration.cogs.commands.{filename[:-3]}")
	for filename in os.listdir("./botConfiguration/cogs/commands/special/"):
		if filename.endswith(".py"):
			await bot.reload_extension(f"botConfiguration.cogs.commands.special.{filename[:-3]}")
