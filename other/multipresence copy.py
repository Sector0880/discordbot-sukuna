...
class MultiplayerEvents(commands.Cog):
	...
	async def on_guild_join(self, guild):
		# open db
		#with open("./.db/multiplayer/guilds/main.json", "r", encoding="utf-8") as read_file: data_main = json.load(read_file) # success
		#with open("./.db/multiplayer/guilds/modules.json", "r", encoding="utf-8") as read_file: data_modules = json.load(read_file) # success
		#with open("./.db/multiplayer/guilds/portal.json", "r", encoding="utf-8") as read_file: data_portal = json.load(read_file) # success
		#with open("./.db/multiplayer/guilds/premium.json", "r", encoding="utf-8") as read_file: data_premium = json.load(read_file) # success
